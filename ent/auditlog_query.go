...
func (_q *AuditLogQuery) QueryRealm() *RealmQuery {
...
func (_q *AuditLogQuery) WithRealm(opts ...func(*RealmQuery)) *AuditLogQuery {
	query := (&RealmClient{config: _q.config}).Query()
...
func (_q *AuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuditLog, error) {
	...
	if query := _q.withRealm; query != nil {
		if err := _q.loadRealm(ctx, query, nodes, nil,
			func(n *AuditLog, e *Realm) { n.Edges.Realm = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AuditLogQuery) loadRealm(ctx context.Context, query *RealmQuery, nodes []*AuditLog, init func(*AuditLog), assign func(*AuditLog, *Realm)) error {
...
func (_q *AuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRealm != nil {
			_spec.Node.AddColumnOnce(auditlog.FieldRealmID)
		}
	}
