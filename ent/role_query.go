...
func (_q *RoleQuery) QueryRealm() *RealmQuery {
...
func (_q *RoleQuery) QueryClientScopes() *ClientScopeQuery {
...
func (_q *RoleQuery) QueryClientApps() *ClientAppQuery {
...
func (_q *RoleQuery) QueryRoleClientScopes() *RoleClientScopeQuery {
...
func (_q *RoleQuery) QueryClientRoles() *ClientRoleQuery {
...
func (_q *RoleQuery) WithRealm(opts ...func(*RealmQuery)) *RoleQuery {
	query := (&RealmClient{config: _q.config}).Query()
...
func (_q *RoleQuery) WithClientScopes(opts ...func(*ClientScopeQuery)) *RoleQuery {
	query := (&ClientScopeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) WithClientApps(opts ...func(*ClientAppQuery)) *RoleQuery {
	query := (&ClientAppClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) WithRoleClientScopes(opts ...func(*RoleClientScopeQuery)) *RoleQuery {
	query := (&RoleClientScopeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) WithClientRoles(opts ...func(*ClientRoleQuery)) *RoleQuery {
	query := (&ClientRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withRealm; query != nil {
		if err := _q.loadRealm(ctx, query, nodes, nil,
			func(n *Role, e *Realm) { n.Edges.Realm = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withClientScopes; query != nil {
		if err := _q.loadClientScopes(ctx, query, nodes,
			func(n *Role) { n.Edges.ClientScopes = []*ClientScope{} },
			func(n *Role, e *ClientScope) { n.Edges.ClientScopes = append(n.Edges.ClientScopes, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withClientApps; query != nil {
		if err := _q.loadClientApps(ctx, query, nodes,
			func(n *Role) { n.Edges.ClientApps = []*ClientApp{} },
			func(n *Role, e *ClientApp) { n.Edges.ClientApps = append(n.Edges.ClientApps, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRoleClientScopes; query != nil {
		if err := _q.loadRoleClientScopes(ctx, query, nodes,
			func(n *Role) { n.Edges.RoleClientScopes = []*RoleClientScope{} },
			func(n *Role, e *RoleClientScope) { n.Edges.RoleClientScopes = append(n.Edges.RoleClientScopes, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withClientRoles; query != nil {
		if err := _q.loadClientRoles(ctx, query, nodes,
			func(n *Role) { n.Edges.ClientRoles = []*ClientRole{} },
			func(n *Role, e *ClientRole) { n.Edges.ClientRoles = append(n.Edges.ClientRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RoleQuery) loadRealm(ctx context.Context, query *RealmQuery, nodes []*Role, init func(*Role), assign func(*Role, *Realm)) error {
...
func (_q *RoleQuery) loadClientScopes(ctx context.Context, query *ClientScopeQuery, nodes []*Role, init func(*Role), assign func(*Role, *ClientScope)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[string]*Role)
	nids := make(map[string]map[*Role]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(role.ClientScopesTable)
		s.Join(joinT).On(s.C(clientscope.FieldID), joinT.C(role.ClientScopesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(role.ClientScopesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.ClientScopesPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *RoleQuery) loadClientApps(ctx context.Context, query *ClientAppQuery, nodes []*Role, init func(*Role), assign func(*Role, *ClientApp)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[string]*Role)
	nids := make(map[string]map[*Role]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(role.ClientAppsTable)
		s.Join(joinT).On(s.C(clientapp.FieldID), joinT.C(role.ClientAppsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(role.ClientAppsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.ClientAppsPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *RoleQuery) loadRoleClientScopes(ctx context.Context, query *RoleClientScopeQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleClientScope)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(roleclientscope.FieldRoleID)
	}
	query.Where(predicate.RoleClientScope(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.RoleClientScopesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *RoleQuery) loadClientRoles(ctx context.Context, query *ClientRoleQuery, nodes []*Role, init func(*Role), assign func(*Role, *ClientRole)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(clientrole.FieldRoleID)
	}
	query.Where(predicate.ClientRole(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.ClientRolesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *RoleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRealm != nil {
			_spec.Node.AddColumnOnce(role.FieldRealmID)
		}
	}
