...
func (_u *SessionUpdate) SetMfaVerified(v bool) *SessionUpdate {
	_u.mutation.SetMfaVerified(v)
	return _u
}

// SetNillableMfaVerified sets the "mfa_verified" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableMfaVerified(v *bool) *SessionUpdate {
	if v != nil {
		_u.SetMfaVerified(*v)
	}
	return _u
...
func (_u *SessionUpdate) SetMfaMethodType(v string) *SessionUpdate {
	_u.mutation.SetMfaMethodType(v)
	return _u
}

// SetNillableMfaMethodType sets the "mfa_method_type" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableMfaMethodType(v *string) *SessionUpdate {
	if v != nil {
		_u.SetMfaMethodType(*v)
	}
	return _u
}

// ClearMfaMethodType clears the value of the "mfa_method_type" field.
func (_u *SessionUpdate) ClearMfaMethodType() *SessionUpdate {
	_u.mutation.ClearMfaMethodType()
	return _u
}

// SetAuthMethod sets the "auth_method" field.
func (_u *SessionUpdate) SetAuthMethod(v string) *SessionUpdate {
	_u.mutation.SetAuthMethod(v)
	return _u
}

// SetNillableAuthMethod sets the "auth_method" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableAuthMethod(v *string) *SessionUpdate {
	if v != nil {
		_u.SetAuthMethod(*v)
	}
	return _u
...
func (_u *SessionUpdate) SetStatus(v schema.SessionStatus) *SessionUpdate {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableStatus(v *schema.SessionStatus) *SessionUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *SessionUpdate) AddTokenIDs(ids ...string) *SessionUpdate {
	_u.mutation.AddTokenIDs(ids...)
	return _u
}

// AddTokens adds the "tokens" edges to the Token entity.
func (_u *SessionUpdate) AddTokens(v ...*Token) *SessionUpdate {
...
func (_u *SessionUpdate) check() error {
	if _u.mutation.RealmCleared() && len(_u.mutation.RealmIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Session.realm"`)
	}
...
func (_u *SessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.MfaMethodType(); ok {
		_spec.SetField(session.FieldMfaMethodType, field.TypeString, value)
	}
	if _u.mutation.MfaMethodTypeCleared() {
		_spec.ClearField(session.FieldMfaMethodType, field.TypeString)
	}
...
// SetMfaVerified sets the "mfa_verified" field.
func (_u *SessionUpdateOne) SetMfaVerified(v bool) *SessionUpdateOne {
	_u.mutation.SetMfaVerified(v)
	return _u
}

// SetNillableMfaVerified sets the "mfa_verified" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableMfaVerified(v *bool) *SessionUpdateOne {
	if v != nil {
		_u.SetMfaVerified(*v)
	}
	return _u
...
// SetMfaMethodType sets the "mfa_method_type" field.
func (_u *SessionUpdateOne) SetMfaMethodType(v string) *SessionUpdateOne {
	_u.mutation.SetMfaMethodType(v)
	return _u
}

// SetNillableMfaMethodType sets the "mfa_method_type" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableMfaMethodType(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetMfaMethodType(*v)
	}
	return _u
...
// ClearMfaMethodType clears the value of the "mfa_method_type" field.
func (_u *SessionUpdateOne) ClearMfaMethodType() *SessionUpdateOne {
	_u.mutation.ClearMfaMethodType()
	return _u
}

// SetAuthMethod sets the "auth_method" field.
func (_u *SessionUpdateOne) SetAuthMethod(v string) *SessionUpdateOne {
	_u.mutation.SetAuthMethod(v)
	return _u
}

// SetNillableAuthMethod sets the "auth_method" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableAuthMethod(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetAuthMethod(*v)
	}
	return _u
...
// SetStatus sets the "status" field.
func (_u *SessionUpdateOne) SetStatus(v schema.SessionStatus) *SessionUpdateOne {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableStatus(v *schema.SessionStatus) *SessionUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddTokenIDs adds the "tokens" edge to the Token entity by IDs.
func (_u *SessionUpdateOne) AddTokenIDs(ids ...string) *SessionUpdateOne {
	_u.mutation.AddTokenIDs(ids...)
	return _u
}

// AddTokens adds the "tokens" edges to the Token entity.
func (_u *SessionUpdateOne) AddTokens(v ...*Token) *SessionUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearTokens clears all "tokens" edges to the Token entity.
func (_u *SessionUpdateOne) ClearTokens() *SessionUpdateOne {
	_u.mutation.ClearTokens()
	return _u
}

// RemoveTokenIDs removes the "tokens" edge to Token entities by IDs.
func (_u *SessionUpdateOne) RemoveTokenIDs(ids ...string) *SessionUpdateOne {
	_u.mutation.RemoveTokenIDs(ids...)
	return _u
}

// RemoveTokens removes "tokens" edges to Token entities.
func (_u *SessionUpdateOne) RemoveTokens(v ...*Token) *SessionUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
