...
func (_c *UserCreate) SetRealmID(v string) *UserCreate {
...
func (_c *UserCreate) SetStatus(v schema.UserStatus) *UserCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *UserCreate) SetNillableStatus(v *schema.UserStatus) *UserCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *UserCreate) SetRealm(v *Realm) *UserCreate {
...
func (_c *UserCreate) AddMfaMethodIDs(ids ...string) *UserCreate {
	_c.mutation.AddMfaMethodIDs(ids...)
	return _c
}

// AddMfaMethods adds the "mfa_methods" edges to the MfaMethod entity.
func (_c *UserCreate) AddMfaMethods(v ...*MfaMethod) *UserCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddMfaMethodIDs(ids...)
}

// AddMfaBackupCodeIDs adds the "mfa_backup_codes" edge to the MfaBackupCode entity by IDs.
func (_c *UserCreate) AddMfaBackupCodeIDs(ids ...string) *UserCreate {
...
func (_c *UserCreate) AddConsentIDs(ids ...string) *UserCreate {
...
func (_c *UserCreate) AddFederatedIdentityIDs(ids ...string) *UserCreate {
...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.RealmID(); !ok {
		return &ValidationError{Name: "realm_id", err: errors.New(`ent: missing required field "User.realm_id"`)}
	}
	if v, ok := _c.mutation.RealmID(); ok {
		if err := user.RealmIDValidator(v); err != nil {
			return &ValidationError{Name: "realm_id", err: fmt.Errorf(`ent: validator failed for field "User.realm_id": %w`, err)}
		}
	}
	...
	if len(_c.mutation.RealmIDs()) == 0 {
		return &ValidationError{Name: "realm", err: errors.New(`ent: missing required edge "User.realm"`)}
	}
	return nil
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.RealmIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   user.RealmTable,
			Columns: []string{user.RealmColumn},
			Bidi:    false,
	...
	if nodes := _c.mutation.MfaMethodsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
