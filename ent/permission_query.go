...
func (_q *PermissionQuery) QueryRealm() *RealmQuery {
...
func (_q *PermissionQuery) WithRealm(opts ...func(*RealmQuery)) *PermissionQuery {
	query := (&RealmClient{config: _q.config}).Query()
...
//		GroupBy(permission.FieldRealmID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Permission.Query().
//		Select(permission.FieldRealmID).
//		Scan(ctx, &v)
...
func (_q *PermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Permission, error) {
	...
	if query := _q.withRealm; query != nil {
		if err := _q.loadRealm(ctx, query, nodes, nil,
			func(n *Permission, e *Realm) { n.Edges.Realm = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *PermissionQuery) loadRealm(ctx context.Context, query *RealmQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Realm)) error {
...
func (_q *PermissionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRealm != nil {
			_spec.Node.AddColumnOnce(permission.FieldRealmID)
		}
	}
