...
func (_u *AuditLogUpdate) SetLevel(v schema.AuditLogLevel) *AuditLogUpdate {
	_u.mutation.SetLevel(v)
	return _u
}

// SetNillableLevel sets the "level" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableLevel(v *schema.AuditLogLevel) *AuditLogUpdate {
	if v != nil {
		_u.SetLevel(*v)
	}
	return _u
...
func (_u *AuditLogUpdate) SetStatus(v schema.AuditLogStatus) *AuditLogUpdate {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableStatus(v *schema.AuditLogStatus) *AuditLogUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *AuditLogUpdate) check() error {
	...
	if _u.mutation.RealmCleared() && len(_u.mutation.RealmIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "AuditLog.realm"`)
	}
	return nil
}
...
// SetLevel sets the "level" field.
func (_u *AuditLogUpdateOne) SetLevel(v schema.AuditLogLevel) *AuditLogUpdateOne {
	_u.mutation.SetLevel(v)
	return _u
}

// SetNillableLevel sets the "level" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableLevel(v *schema.AuditLogLevel) *AuditLogUpdateOne {
	if v != nil {
		_u.SetLevel(*v)
	}
	return _u
...
// SetStatus sets the "status" field.
func (_u *AuditLogUpdateOne) SetStatus(v schema.AuditLogStatus) *AuditLogUpdateOne {
	_u.mutation.SetStatus(v)
	return _u
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableStatus(v *schema.AuditLogStatus) *AuditLogUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
