...
func (_c *PermissionCreate) SetRealmID(v string) *PermissionCreate {
...
func (_c *PermissionCreate) SetStatus(v schema.PermissionStatus) *PermissionCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableStatus(v *schema.PermissionStatus) *PermissionCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *PermissionCreate) SetConstraints(v map[string]interface{}) *PermissionCreate {
...
func (_c *PermissionCreate) SetRealm(v *Realm) *PermissionCreate {
...
func (_c *PermissionCreate) AddGroupIDs(ids ...string) *PermissionCreate {
...
func (_c *PermissionCreate) check() error {
	if _, ok := _c.mutation.RealmID(); !ok {
		return &ValidationError{Name: "realm_id", err: errors.New(`ent: missing required field "Permission.realm_id"`)}
	}
	if v, ok := _c.mutation.RealmID(); ok {
		if err := permission.RealmIDValidator(v); err != nil {
			return &ValidationError{Name: "realm_id", err: fmt.Errorf(`ent: validator failed for field "Permission.realm_id": %w`, err)}
		}
	}
	...
	if len(_c.mutation.RealmIDs()) == 0 {
		return &ValidationError{Name: "realm", err: errors.New(`ent: missing required edge "Permission.realm"`)}
	}
	return nil
}
...
func (_c *PermissionCreate) createSpec() (*Permission, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.RealmIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   permission.RealmTable,
			Columns: []string{permission.RealmColumn},
			Bidi:    false,
