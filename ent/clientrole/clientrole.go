...
const (
	// Label holds the string label denoting the clientrole type in the database.
	Label = "client_role"
	...
	EdgeRole = "role"
	// Table holds the table name of the clientrole in the database.
	Table = "client_roles"
	// ClientAppTable is the table that holds the client_app relation/edge.
	ClientAppTable = "client_roles"
...
// Columns holds all SQL columns for clientrole fields.
var Columns = []string{
	FieldID,
	FieldClientAppID,
	FieldRoleID,
...
// OrderOption defines the ordering options for the ClientRole queries.
